...
export const OUTPUT_IMAGE_FORMATS_WITH_ALPHA: OutputImageFormatSupportsAlpha[] = [
  "avif",
  "png",
  "tiff",
  "webp",
];
export const OUTPUT_IMAGE_FORMATS_WITHOUT_ALPHA: OutputImageFormatNotSupportsAlpha[] = [
  "gif",
  "jpeg",
  "jpg",
];
...
function normalizeOutputImageFormats({ src, formats }: PictureSourceOptions): OutputImageFormat[] {
  const finalFormats: OutputImageFormat[] =
